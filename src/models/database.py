...
from sqlalchemy import create_engine, Column, String, Float, Integer, DateTime, Boolean, ForeignKey, Text, JSON
...
def init_db(database_url: str = None):
    ...
    if database_url is None:
        database_url = os.getenv(
            'DATABASE_URL', 
            'postgresql://crosssell_user:password@localhost/crosssell_db'
        )
