...
from src.models.database import (
    Organization, Account, Opportunity, CrossSellRecommendation,
    ModelMetadata, SyncLog, init_db
)
...
class CrossSellOrchestrator:
    ...
    def __init__(self, config_path: str = 'config/orgs.json'):
        ...
        self.db_url = os.getenv(
            'DATABASE_URL',
            'postgresql+asyncpg://crosssell_user:password@localhost/crosssell_db'
        )
        self.engine = None
    ...
    async def _send_notifications(self, recommendations: pd.DataFrame):
        ...
        high_value = recommendations[
            ...
            (recommendations['estimated_value'] > 100000)
        ]
